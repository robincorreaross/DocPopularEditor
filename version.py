"""
DocPopular Editor - Version & Supabase Configuration.
"""

# Versão atual do aplicativo (Semântica: MAJOR.MINOR.PATCH)
APP_VERSION = "1.0.0"  # Nova versão para o DocPopularEditor
...
SUPABASE_TABLE = "doc_popular_editor"

# --- Configurações de Auto-Update (DocPopular Auto Update Skill) ---
GITHUB_USER = "robincorreaross"
GITHUB_REPO = "DocPopularEditor"
APP_NAME = "DocPopularEditor"
